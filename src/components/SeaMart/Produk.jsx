...
import { SeaMartProduk } from "../../data/SeaMartProduk/data";

const Produk = () => {
  const midpoint = Math.ceil(SeaMartProduk.length / 2);
  const firstHalf = SeaMartProduk.slice(0, midpoint);
  const secondHalf = SeaMartProduk.slice(midpoint);

  return (
    <div className=" md:px-4 mt-8">
      <div className="flex justify-between items-center mb-2 px-4 md:px-0">
        <h2 className="font-semibold text-lg">
          Choice of <span className="text-blue-600 font-bold">fresh</span> catch
        </h2>
